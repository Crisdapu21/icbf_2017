...
def guardarCaracteristicas(request):
    if request.method == 'POST':
        if request.POST['b_estado'] == "INCOMPLETO":
            ...
            registrarLogs(request.user.first_name+" "+request.user.last_name,'GUARDAR','Caracteristicas de Vivienda','Guardar Caracteristicas de Vivienda',b.primer_nombre+" "+b.segundo_nombre+" "+b.primer_apellido+" "+b.segundo_apellido)
        else:
            b = Beneficiario.objects.get(id = request.POST['b_ben'])
            ...
            registrarLogs(request.user.first_name+" "+request.user.last_name,'ACTUALIZAR','Caracteristicas de Vivienda','Actualizar Caracteristicas de Vivienda',b.primer_nombre+" "+b.segundo_nombre+" "+b.primer_apellido+" "+b.segundo_apellido)
