...
def guardarRelaciones(request):
    if request.method == 'POST':
        if request.POST['d_estado'] == "INCOMPLETO":
            ...
            d.save()
            registrarLogs(request.user.first_name+" "+request.user.last_name,'GUARDAR','Relaciones Comunitarias','Guardar Relaciones Comunitarias',d.primer_nombre+" "+d.segundo_nombre+" "+d.primer_apellido+" "+d.segundo_apellido)
        else:
            ...
            d = Beneficiario.objects.get(id= request.POST['d_ben'])
            registrarLogs(request.user.first_name+" "+request.user.last_name,'ACTUALIZAR','Relaciones Comunitarias','Actualizar Relaciones Comunitarias',d.primer_nombre+" "+d.segundo_nombre+" "+d.primer_apellido+" "+d.segundo_apellido)
