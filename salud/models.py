...
class Salud(models.Model):
    ...
    f4 =  models.CharField( max_length=2, null=False ,blank=False)
    ...
    f6 = models.TextField(null=False ,blank=False)
    id_f6 = models.TextField(null=False ,blank=False)
    ...
    f7 =  models.CharField( max_length=2, null=False ,blank=False)
    #F8. En caso de no contar con el Carnet de Vacunación al día según la edad del niño o niña ¿ Cuál ha sido el motivo ?
    f8 = models.TextField(null=False ,blank=False)
    id_f8 = models.TextField(null=False ,blank=False)
    ...
    f9 =  models.CharField( max_length=2, null=False ,blank=False)
    #F10. ¿El niño o niña menor de 4 años ¿ Ha recibido valoración Auditiva ?
    f10 =  models.CharField( max_length=2, null=False ,blank=False)
